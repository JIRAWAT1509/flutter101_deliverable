...
import 'package:my_first_app/models/weather_model.dart';
import 'package:dio/dio.dart';
import 'package:flutter_dotenv/flutter_dotenv.dart';
import 'package:my_first_app/utils/location_service.dart';
...
class WeatherViewModel extends ChangeNotifier {
  ...
  void fetchAllData() async {
    ...
    await Future.wait([fetchWeatherData(), fetchForcastData()]);
